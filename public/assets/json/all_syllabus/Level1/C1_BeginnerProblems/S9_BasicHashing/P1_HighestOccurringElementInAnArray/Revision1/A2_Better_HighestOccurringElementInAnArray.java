 ...
 */
public class A2_Better_HighestOccurringElementInAnArray {

    // Solution : Better Approach - Highest occurring element in an array
    ...
    public static void solution(int[] arr) {
        System.out.println("\n Highest occurring element in an array - Better Approach : " + Arrays.toString(arr));
    }
}

 ...
 */
public class A2_Better_LargestOddNumberInAString {

    // Solution : Better Approach - Largest odd number in a string
    ...
    public static void solution(int[] arr) {
        System.out.println("\n Largest odd number in a string - Better Approach : " + Arrays.toString(arr));
    }
}

 ...
 */
public class A3_Optimal_CountAllDigitsOfANumber {

    // Solution : Optimal Approach - Count all digits of a number
    ...
    public static void solution(int[] arr) {
        System.out.println("\n Count all digits of a number - Optimal Approach : " + Arrays.toString(arr));
    }
}

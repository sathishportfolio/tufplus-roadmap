 ...
 */
public class A3_Optimal_CheckIfTheNumberIfArmstrong {

    // Solution : Optimal Approach - Check if the number is armstrong
    ...
    public static void solution(int[] arr) {
        System.out.println("\n Check if the number is armstrong - Optimal Approach : " + Arrays.toString(arr));
    }
}

 ...
 */
public class A2_Better_CheckIfTheNumberIfArmstrong {

    // Solution : Better Approach - Check if the number is armstrong
    ...
    public static void solution(int[] arr) {
        System.out.println("\n Check if the number is armstrong - Better Approach : " + Arrays.toString(arr));
    }
}

 ...
 */
public class A3_Optimal_CountOfPrimeNumbersTillN {

    // Solution : Optimal Approach - Count of prime numbers till N
    ...
    public static void solution(int[] arr) {
        System.out.println("\n Count of prime numbers till N - Optimal Approach : " + Arrays.toString(arr));
    }
}

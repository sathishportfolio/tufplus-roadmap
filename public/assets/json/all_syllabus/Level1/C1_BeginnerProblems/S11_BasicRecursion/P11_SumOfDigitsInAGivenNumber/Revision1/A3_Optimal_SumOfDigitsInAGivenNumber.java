 ...
 */
public class A3_Optimal_SumOfDigitsInAGivenNumber {

    // Solution : Optimal Approach - Sum of digits in a given number
    ...
    public static void solution(int[] arr) {
        System.out.println("\n Sum of digits in a given number - Optimal Approach : " + Arrays.toString(arr));
    }
}

 ...
 */
public class A2_Better_CheckIfANumberIsPrimeOrNot {

    // Solution : Better Approach - Check if a number is prime or not
    ...
    public static void solution(int[] arr) {
        System.out.println("\n Check if a number is prime or not - Better Approach : " + Arrays.toString(arr));
    }
}

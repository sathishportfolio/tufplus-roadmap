 ...
 */
public class A2_Better_CountOfOddNumbersInArray {

    // Solution : Better Approach - Count of odd numbers in array
    ...
    public static void solution(int[] arr) {
        System.out.println("\n Count of odd numbers in array - Better Approach : " + Arrays.toString(arr));
    }
}

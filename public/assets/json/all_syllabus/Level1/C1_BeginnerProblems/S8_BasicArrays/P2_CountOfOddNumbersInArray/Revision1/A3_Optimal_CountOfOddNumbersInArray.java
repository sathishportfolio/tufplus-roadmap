 ...
 */
public class A3_Optimal_CountOfOddNumbersInArray {

    // Solution : Optimal Approach - Count of odd numbers in array
    ...
    public static void solution(int[] arr) {
        System.out.println("\n Count of odd numbers in array - Optimal Approach : " + Arrays.toString(arr));
    }
}
